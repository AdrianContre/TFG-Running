...
import com.example.API_Running.models.MobilitySessionResult;
...
public class MobilityResultDTO {
    private Long id;
    ...
    public MobilityResultDTO(MobilitySessionResult ssr, String planName) {
        this.id = ssr.getId();
